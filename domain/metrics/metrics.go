...
type ContainerAttributes struct {
	...
	// what ties a multi-container service's per-container metrics (Supabase:
	// kong/auth/realtime/…; Twenty/n8n: web/worker/db/cache) back to the
	// CoolifyService. container_name and
